...
class BaseChecklist : AppCompatActivity(){
    ...
    var currentTask: SimpleViewModel = SimpleViewModel("")
    var currentListofLists = ListofLists("Your CheckLists", "none")
    var currentListView: ArrayList<SimpleViewModel> = ArrayList()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (listFileExists()){
            ...
            adapter = SimpleAdapter(this, recyclerView, currentListView, this::popupPresent, layoutInflater, this::currentTask, this::currentChecklist, currentUser)
...
//        }
        ...
        if (!popupPresent) {
            ...
            taskSettingsLayoutView.ChangeNameSettingsButton.setOnClickListener {
                ...
                taskSettingsChangeNameLayoutView.ChangeNameButton.setOnClickListener {
                    ...
                    currentTask?.simpleText = newName
            ...
            taskSettingsLayoutView.taskNameView.text = currentTask?.simpleText
    ...
    fun createNewTask(TaskText: String, IsReaccuring: Boolean, taskID: Int?) {
        var new_task_box = SimpleViewModel(TaskText)
...
//            }
        ...
        //Sets the on click listener for the new task gui element
...
//        }
    ...
    fun addTask(task: Task) {
        var new_task_box = SimpleViewModel("")
...
//        }
    ...
    fun addTaskFromList(task: Task) {
        var new_task_box = SimpleViewModel(task.name)
...
//        }
    ...
    fun onClickFun(item: SimpleViewModel, position: Int)
    {
        val popupFunctionWindow = PopupWindow(this)
        val mainView = findViewById<RecyclerView>(R.id.simple_recyclerview)
        if(!popupPresent) {
